                ...
                children: [
                  ...
                  StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final profileName = data?['usuario'] as String? ?? user.name;
                      final profileEmail = data?['correo'] as String? ?? user.email;
                      final profilePhone = data?['telefono'] as String? ?? user.phone;

                      return Column(
                        children: [
                          Text(profileName.isEmpty ? 'Sin nombre' : profileName,
                              style: const TextStyle(
                                  color: AppTheme.textPrimary,
                                  fontWeight: FontWeight.w800,
                                  fontSize: 22)),
